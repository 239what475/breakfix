...
func TestCopyRegularFilesPreservesNestedAssets(t *testing.T) {
	...
	for name, content := range map[string]string{
		"scenario.yaml": "title: demo\n",
		"nodes/host/assertions/final-checkpoint-one.sh": "#!/bin/sh\n",
	...
	for _, name := range []string{"scenario.yaml", "nodes/host/assertions/final-checkpoint-one.sh", "hints/checkpoint-one.md"} {

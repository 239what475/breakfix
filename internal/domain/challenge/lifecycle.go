// Package challenge contains the durable identity lifecycle of a published
// challenge. Portable challenge files live in content/challenge; this package
...
// Challenge is the stable identity. Its active revision is a pointer, not the
...
var (
	...
	ErrRevisionConflict = errors.New("challenge active revision changed")
	ErrNotMutable       = errors.New("challenge cannot be modified")
)

...
func (p Planner) Plan(ctx context.Context, path, anchor string) (domain.LearningUnitPlan, error) {
	...
	if plan.Context.SourceID != page.Context.SourceID || plan.Context.Repository != page.Context.Repository || plan.Context.Commit != page.Context.Commit || plan.Context.Version != page.Context.Version || plan.Context.Language != page.Context.Language || plan.Context.License != page.Context.License || plan.Context.MirrorOrigin != page.Context.MirrorOrigin || plan.Context.MirrorDigest != page.Context.MirrorDigest || plan.Context.PagePath != path {

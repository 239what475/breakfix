...
`catalog-release/` is a complete portable Catalog Release source. Browser E2E
installs its immutable OCI bundle through the administrator API when the target
platform has no catalog.
